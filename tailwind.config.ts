    ...
    extend: {
      colors: {
        ...
        hiyya: {
          ...
          gold: "var(--hiyya-gold)",
          "gold-ink": "var(--hiyya-gold-ink)",
          champagne: "var(--hiyya-champagne)",
          "champagne-ink": "var(--hiyya-champagne-ink)",
          ...
          gain: "var(--hiyya-gain)",
          "gain-ink": "var(--hiyya-gain-ink)",
          loss: "var(--hiyya-loss)",
          "loss-ink": "var(--hiyya-loss-ink)",
          warning: "var(--hiyya-warning)",
          "warning-ink": "var(--hiyya-warning-ink)",
        },
        branch: {
