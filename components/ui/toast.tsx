...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Always bottom-anchored — top-0 at mobile widths used to sit directly on top
      // of the header/persona-switcher/tab bar, which is exactly where Phase 6's
      // Purchases/Wastage forms need their toast feedback to *not* be.
